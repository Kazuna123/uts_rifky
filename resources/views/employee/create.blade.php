        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a href="{{ route('profile') }}" class="btn btn-outline-light"><i class="bi-person-circle me-1"></i> My Profile</a></li>
                </ul>
            </div>
        </div>
    </nav>
        ...
        <form action="{{ route('employees.store') }}" method="POST">
            ...
            <div class="p-4 bg-light rounded-3 border">
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control @error('kodeBarang') is-invalid @enderror" id="kodeBarang" name="kodeBarang" value="{{ old('kodeBarang') }}" placeholder="Enter product kode">
                ...
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-success btn-lg"><i class="bi-check-circle me-2"></i>Save</button>
                    <a href="{{ route('employees.index') }}" class="btn btn-outline-secondary btn-lg"><i class="bi-arrow-left-circle me-2"></i>Cancel</a>
                </div>
            </div>
        </form>
    </div>
