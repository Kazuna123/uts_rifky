        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a href="<?php echo e(route('profile')); ?>" class="btn btn-outline-light"><i class="bi-person-circle me-1"></i> My Profile</a></li>
                </ul>
            </div>
        </div>
    </nav>
...
unset($__errorArgs, $__bag); ?>" id="kodeBarang" name="kodeBarang" value="<?php echo e(old('kodeBarang')); ?>" placeholder="Enter product kode">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="d-grid gap-2">
                    ...
                    <a href="<?php echo e(route('employees.index')); ?>" class="btn btn-outline-secondary btn-lg"><i class="bi-arrow-left-circle me-2"></i>Cancel</a>
                </div>
            </div>
        </form>
    </div>
