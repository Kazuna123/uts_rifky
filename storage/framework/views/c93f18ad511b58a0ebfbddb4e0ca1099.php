  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-success text-light">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <a href="<?php echo e(route('profile')); ?>" class="btn btn-outline-light my-2 ms-md-auto" style="background-color: green;"><i class="bi-person-circle me-1"></i> My Profile</a>
        </div>
    </div>
</nav>
        ...
        <div class="col-md-12">
            ...
            <div class="col-lg-3 col-xl-3">
                <div class="d-grid gap-2">
                    <a href="<?php echo e(route('employees.create')); ?>" class="btn btn-primary" style="background-color: green;">Create Employee</a>
                </div>
            </div>
